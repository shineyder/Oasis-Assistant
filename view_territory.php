                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Territórios</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
<div id="Mapa_Completo" class="">
    <img class="map" src="mapas/Mapa_completo.jpg" alt="Mapa Completo" usemap="#Mapa_Completo">
...
<div id="Mapa_Regio" class="hide">
    <div id="Porto_novo_1" class="hide">
        <img class="map" src="mapas/Porto_novo_1.jpg" alt="Mapa Regional" usemap="#Porto_novo_1">
    ...
    <div id="Porto_novo_2" class="hide">
        <img class="map" src="mapas/Porto_novo_2.jpg" alt="Mapa Regional" usemap="#Porto_novo_2">
    ...
    <div id="Bairro_aparecida" class="hide">
        <img class="map" src="mapas/Bairro_aparecida.jpg" alt="Mapa Regional" usemap="#Bairro_aparecida">
    ...
    <div id="Presidente_medici" class="hide">
        <img class="map" src="mapas/Presidente_medici.jpg" alt="Mapa Regional" usemap="#Presidente_medici">
    ...
    <div id="Morro_Sesi" class="hide">
        <img class="map" src="mapas/Morro_Sesi.jpg" alt="Mapa Regional" usemap="#Morro_Sesi">
    ...
    <div id="Del_porto" class="hide">
        <img class="map" src="mapas/Del_porto.jpg" alt="Mapa Regional" usemap="#Del_porto">
...
function edit2(param) {
    ...
    document.getElementById("Mapa_Local_img").setAttribute("src", "mapas/" + param + ".jpg");
