...
<ul>
    <p><li><b>1. Por que o site acessou direto sem pedir para fazer login?</b></li>
    <li>No último acesso você provavelmente não apertou em sair, então a sessão foi mantida aberta.</li></p>

    <p><li><b>2. No perfil meu grupo está como "à definir" ou está incorreto, como eu mudo isso?</b></li>
    ...
    <p><li><b>3. Fiz um relatório, mas cometi um erro, o que eu faço?</b></li>
    <li>Vá na sessão Meus Relatórios e procure o relatório incorreto, lá você poderá deleta-lo ou corrigi-lo.</li></p>

    <p><li><b>4. Estou acessando o site pelo celular e os links do mapa não estão funcionando, como consertar?</b></li>
    <li>Ative rotação de tela, gire a tela e volte ao normal, isso atualizará a imagem e corrigirá o link.</li></p>

    <p><li><b>5. Enquanto estava usando o site tive uma ideia para melhora, como entre em contato com o desenvolvedor?</b></li>
    <li>Não faça contato via mensagem, use a sessão Fale Conosco que um e-mail com sua suguestão será enviado.</li></p>

    <p><li><b>6. Tive um problema ao usar o site e não consegui resolver, com quem entro em contato?</b></li>
    <li>Veja resposta da questão 5.</li></p>

    <p><li><b>7. Enviei uma solicitação pelo Fale Conosco, o que eu faço agora?</b></li>
    ...
    <p><li><b>8. Não estou encontrando o e-mail enviado, o que aconteceu?</b></li>
    <li>Provavelmente o e-mail foi para a caixa de spam.</li></p>

    <p><li><b>9. Baixei uma planilha e tentei abrir direto pelo Outlook, mas deu erro, o que fazer?</b></li>
    <li>As planilhas são geradas automáticamente pelo sistema, para conseguir visualizar será necessário usar o Excel.</li></p>

    <p><li><b>10. Baixei uma planilha e tentei abrir pelo Excel, mas deu uma mensagem de arquivo corrompido ou não seguro, o que fazer?</b></li>
